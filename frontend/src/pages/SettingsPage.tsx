  ...
  return (
    ...
    >
      ...
      <p className="footnote footnote--left">
        Напоминание приходит в начале выбранного часа. Горизонт планирования
        определяет приоритет продуктов по сроку годности. Свежие продукты
        за его пределами тоже могут входить в рецепт.
      </p>
    </Screen>
  )
}
